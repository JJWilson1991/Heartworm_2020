...
Diro_col%<>%mutate(Leukophilia=ifelse(WBC>19.5,1, 0))
table(Diro_col$Leukopenia, Diro_col$Dirofilaria)
table(Diro_col$Leukophilia, Diro_col$Dirofilaria)
chisq.test(table(Diro_col$Leukopenia, Diro_col$Dirofilaria))
chisq.test(table(Diro_col$Leukophilia, Diro_col$Dirofilaria))
```
```{r}
